...
!petr3 está ali pois será o y, enquanto petr3_pred guarda o resultado do modelo
    ...
    do i=1, nlines 
        ...
        read (1,*) datas(i),  (predictors(i,j),j=1,nvar) , petr3(i,1)
    enddo
    ...
    if (iout .eq. 0) then ! Post processing
        ...
        write(2,*)'acquisitions       data                    prediction '
        do i = 1, nlines
            write(2,'(i5,f10.2,f10.2)') i,petr3(i,1),petr3_pred(i) ! printing Y data, Y pred
        enddo
